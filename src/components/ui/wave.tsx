...
export function Wave({
  ...
  const pointerRef = useRef(localPointer)
  pointerRef.current = localPointer

  useEffect(() => {
    if (disablePointerTracking || pointerOverride) return
  ...
  }, [disablePointerTracking, pointerOverride])
